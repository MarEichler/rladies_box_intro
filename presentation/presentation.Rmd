...
<div id="column2" style="float:left; width:38%;">
  ...
  <div class="sourceCode" id="cb1"><pre class="sourceCode r" style="border: 1px solid white;"><code class="sourceCode r"><span 
      id="cb1-1"><a href="#cb1-1" aria-hidden="true" tabindex="-1"></a>DIR_ROOT  </span>
...
<span id="cb1-6"><a href="#cb1-6" aria-hidden="true" tabindex="-1"></a>|   |---Bbox.R  </span>
<span id="cb1-7"><a href="#cb1-7" aria-hidden="true" tabindex="-1"></a>|   </span>
<span id="cb1-8"><a href="#cb1-8" aria-hidden="true" tabindex="-1"></a>|---my.Rmd <span class="co">#rmd file using box modules</span></span>
</code></pre></div>
</div>
...
<div>
<div id="column1" class="mycolumn" style="width:47.25%;">
<div class="sourceCode" id="cb1"><pre class="sourceCode r"><code class="sourceCode r"><span 
      id="cb1-1"><a href="#cb2-1" aria-hidden="true" tabindex="-1"></a>box::reload(Abox) <span class="co">#just include name, not full pathway/folder</span></span>
</code></pre></div>
</div>
<div id="column2" class="mycolumn" style="width:47.25%;">
...
<div id="column1" style="float:left; width:49.25%;">
...
<span id="cb2-1"><a href="#cb2-1" aria-hidden="true" tabindex="-1"></a>box::<span class="fu">use</span>( ./admin)  </span>
  ...
  <div class="sourceCode" id="cb2"><pre class="sourceCode r" style="border: 1px solid white;"><code class="sourceCode r"><span 
      id="cb2-1"><a href="#cb2-1" aria-hidden="true" tabindex="-1"></a>DIR_ROOT  </span>
...
<div id="column2" style="float:left; width:49%;">
<div style="text-indent:25px;">Use a box module <b>up at directory</b></div>
